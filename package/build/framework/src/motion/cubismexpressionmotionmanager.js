...
const cubismexpressionmotion_1 = require("./cubismexpressionmotion");
const cubismmotionqueuemanager_1 = require("./cubismmotionqueuemanager");
...
const $ = __importStar(require("./cubismexpressionmotionmanager"));
