...
const csmmap_1 = require("../type/csmmap");
const csmvector_1 = require("../type/csmvector");
const cubismdebug_1 = require("../utils/cubismdebug");
const cubismclippingmanager_1 = require("./cubismclippingmanager");
const cubismrenderer_1 = require("./cubismrenderer");
const cubismshader_webgl_1 = require("./cubismshader_webgl");
let s_viewport;
let s_fbo;
/**
...
const $ = __importStar(require("./cubismrenderer_webgl"));
